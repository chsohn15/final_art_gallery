...
function loadRoom(paintings){
    ...
    //Place each painting on the DOM
        ...
        imgP.addEventListener("click", function(){
            ...
            if (painting === paintings[0]){
                ...
                tourBtn.addEventListener("click", function(){
                    alert("Clicked")
                    mainBody.innerHTML = ""
                    mainBody.innerHTML = '<svg  version="1.1"  viewport="0 0 600 600" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><image id="voyage-youth" href="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Thomas_Cole_-_The_Voyage_of_Life_Youth%2C_1842_%28National_Gallery_of_Art%29.jpg/1599px-Thomas_Cole_-_The_Voyage_of_Life_Youth%2C_1842_%28National_Gallery_of_Art%29.jpg" x="0" y="0" height= "90%" width="100%" ></svg>'
    ...
    // Function to draw images and frames
    function draw() {
        //debugger
