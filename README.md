...
To run this project, open the folder 'backend' and run 'bundle install' and 'rails s.' In the 'frontend' folder, run 'npm install' and 'open index.html' in the terminal. 
